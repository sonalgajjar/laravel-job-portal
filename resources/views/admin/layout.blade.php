...
<head>
    ...
    <title>@yield('title', 'Admin Panel') — JobPortal Pro</title>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .logo-icon-sm{width:34px;height:34px;background:#1e293b;border-radius:9px;display:flex;align-items:center;justify-content:center;font-size:16px;flex-shrink:0}

        .sidebar-admin{padding:14px 16px;border-bottom:1px solid #e2e8f0;display:flex;align-items:center;gap:10px}
        .admin-avatar{width:38px;height:38px;border-radius:9px;background:#1e293b;display:flex;align-items:center;justify-content:center;font-size:15px;font-weight:700;color:#fff;flex-shrink:0}
        ...
        .nav-item.active i{color:#1e293b}
        .sidebar-footer{padding:12px 10px;border-top:1px solid #e2e8f0}
        .nav-badge{background:#ef4444;color:#fff;border-radius:10px;padding:1px 6px;font-size:11px;font-weight:700;margin-left:auto}
        ...
        .form-control:focus{border-color:#1e293b;box-shadow:0 0 0 3px rgba(30,41,59,0.08)}
...
<aside class="sidebar">
    <div class="sidebar-logo">
        <a href="{{ route('admin.dashboard') }}">
            ...
            Admin <span style="color:#64748b;font-size:11px;font-weight:600;margin-left:3px">Panel</span>
        </a>
    </div>
...
<div class="main-content">
    <header class="topbar">
        <div class="topbar-left">@yield('page-title', 'Admin Panel')</div>
        <div class="topbar-right">
            <a href="{{ route('admin.companies') }}" class="topbar-btn">
                <i class="fas fa-building"></i> Companies
                @if($pendingCount > 0)<span style="background:#ef4444;color:#fff;border-radius:10px;padding:1px 6px;font-size:11px;font-weight:700;margin-left:4px">{{ $pendingCount }}</span>@endif
            </a>
            <a href="{{ route('admin.settings') }}" class="topbar-btn"><i class="fas fa-cog"></i></a>
        </div>
    </header>
